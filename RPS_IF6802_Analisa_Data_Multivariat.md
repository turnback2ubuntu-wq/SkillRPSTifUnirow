...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Sub-CPMK1**: Konsep multivariat, matriks data, mean vektor, kovarians `[C2]` | **V** | | | CPMK1 | 5% | Minggu 1 (150' PB, 180' PT+BM) |
| **Sub-CPMK2**: Uji normalitas multivariat & jarak Mahalanobis outlier `[C3]` | **V** | | | CPMK1 | 5% | Minggu 2 (150' PB, 180' PT+BM) |
| **Sub-CPMK3**: Principal Component Analysis (PCA), eigen, scree, biplot `[C4]` | | **V** | | CPMK2 | 8% | Minggu 3 (150' PB, 180' PT+BM) |
| **Sub-CPMK4**: Exploratory Factor Analysis (EFA), rotasi Varimax/Promax `[C4]` | | **V** | | CPMK2 | 7% | Minggu 4 (150' PB, 180' PT+BM) |
| **Sub-CPMK5**: Regresi Linier Berganda multivariat & diagnosa asumsi VIF `[C4]` | | **V** | | CPMK3 | 7% | Minggu 5 (150' PB, 180' PT+BM) |
| **Sub-CPMK6**: Regresi Logistik Biner & Multinomial multivariat `[C4]` | | **V** | | CPMK3 | 8% | Minggu 6 (150' PB, 180' PT+BM) |
| **Sub-CPMK7**: MANOVA, Wilks' Lambda, Hotelling's T², Box's M `[C4, C5]` | | **V** | | CPMK3 | 10% | Minggu 7 (150' PB, 180' PT+BM) |
| **UTS (Evaluasi Tengah Semester)**: Ujian Teori & Kasus Komputasi | **V** | **V** | | CPMK1,2,3 | 15% | Minggu 8 (150 Menit) |
| **Sub-CPMK8**: Linear & Quadratic Discriminant Analysis (LDA/QDA) `[C5]` | | | **V** | CPMK4 | 6% | Minggu 9 (150' PB, 180' PT+BM) |
| **Sub-CPMK9a**: Hierarchical Agglomerative Clustering & Dendrogram `[C5]` | | | **V** | CPMK4 | 7% | Minggu 10 (150' PB, 180' PT+BM) |
| **Sub-CPMK9b**: K-Means Clustering & Evaluasi Silhouette `[C5, C6]` | | | **V** | CPMK4 | 7% | Minggu 11 (150' PB, 180' PT+BM) |
| **Sub-CPMK10a**: Multidimensional Scaling (MDS) Metrik & Non-Metrik `[C5]` | | | **V** | CPMK4 | 5% | Minggu 12 (150' PB, 180' PT+BM) |
| **Sub-CPMK10b**: Correspondence Analysis (CA & MCA) data kategori `[C5]` | | | **V** | CPMK4 | 5% | Minggu 13 (150' PB, 180' PT+BM) |
| **Sub-CPMK11a**: Integrasi Pipeline Analisis Multivariat Riil `[C5, C6]` | | | **V** | CPMK4 | 5% | Minggu 14 (150' PB, 180' PT+BM) |
| **Sub-CPMK11b**: Presentasi Ilmiah & Diseminasi Temuan Multivariat `[C5, C6]` | | | **V** | CPMK4 | 7% | Minggu 15 (150' PB, 180' PT+BM) |
| **UAS (Evaluasi Akhir Semester)**: Final Project Report & Code Review | | | **V** | CPMK3,4 | 15% | Minggu 16 (150 Menit) |
